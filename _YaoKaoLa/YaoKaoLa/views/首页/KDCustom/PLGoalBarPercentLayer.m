...
@implementation PLGoalBarPercentLayer
@synthesize percent;
...
-(void)DrawRight:(CGContextRef)ctx {
    ...
    CGContextSetFillColorWithColor(ctx,[UIColor colorWithRed:142/255.0 green:193/255.0 blue:51/255.0 alpha:1.0].CGColor);
