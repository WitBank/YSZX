...
+ (void)registerForNetworkReachabilityNotifications
{
	[[HJSTK_Reachability reachabilityForInternetConnection] startNotifier];
	[[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(reachabilityChanged:) name:HJSTK_kReachabilityChangedNotification object:nil];
}


+ (void)unsubscribeFromNetworkReachabilityNotifications
{
	[[NSNotificationCenter defaultCenter] removeObserver:self name:HJSTK_kReachabilityChangedNotification object:nil];
}

+ (BOOL)isNetworkReachableViaWWAN
{
	return ([[HJSTK_Reachability reachabilityForInternetConnection] currentReachabilityStatus] == HJSTK_ReachableViaWWAN);
}
